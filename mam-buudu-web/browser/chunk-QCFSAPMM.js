...
var SuperAdminService = class _SuperAdminService {
  ...
  // Mot de passe
  changePassword(ancienPassword, nouveauPassword) {
    return this.http.post(`${this.base}/change-password`, { ancienPassword, nouveauPassword }, this.headers());
  }
  resetUserPassword(userId, newPassword) {
    return this.http.post(`${this.base}/users/${userId}/reset-password`, { newPassword }, this.headers());
  }
...
function SaShellComponent_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "a", 9)(2, "span", 7);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
var SaShellComponent = class _SaShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SaShellComponent, selectors: [["sa-shell"]], standalone: false, decls: 14, vars: 0, consts: [[1, "sa-layout"], [1, "sa-sidebar"], [1, "sa-logo"], [1, "sa-logo-badge"], ["src", "images/logobg.png", "alt", "Mam Buudu"], [1, "sa-nav"], [1, "sa-logout", 3, "click"], [1, "material-icons-round"], [1, "sa-main"], ["routerLinkActive", "active", 3, "routerLink"]], template: function SaShellComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "nav", 1)(2, "div", 2)(3, "div", 3);
      \u0275\u0275element(4, "img", 4);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(5, "ul", 5);
      \u0275\u0275repeaterCreate(6, SaShellComponent_For_7_Template, 6, 3, "li", null, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "button", 6);
      \u0275\u0275listener("click", function SaShellComponent_Template_button_click_8_listener() {
        return ctx.logout();
      });
      \u0275\u0275elementStart(9, "span", 7);
      \u0275\u0275text(10, "logout");
      \u0275\u0275elementEnd();
      \u0275\u0275text(11, " D\xE9connexion ");
      \u0275\u0275elementEnd()();
...
function SaUsersComponent_Conditional_30_For_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SaUsersComponent_Conditional_30_For_20_Template_button_click_26_listener() {
      const u_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.resetPassword(u_r4));
    });
    \u0275\u0275elementStart(27, "span", 4);
    \u0275\u0275text(28, "key");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "button", 28);
    \u0275\u0275listener("click", function SaUsersComponent_Conditional_30_For_20_Template_button_click_29_listener() {
      const u_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(20, 20, u_r4.createdAt, "dd/MM/yy"));
    \u0275\u0275advance(4);
...
function SaUsersComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(19, SaUsersComponent_Conditional_30_For_20_Template, 32, 23, "tr", 18, _forTrack04);
    \u0275\u0275elementEnd()()();
...
var SaUsersComponent = class _SaUsersComponent {
  ...
  resetPassword(u) {
    const nom = `${u.prenom} ${u.nom}`;
    const newPassword = prompt(`Nouveau mot de passe pour "${nom}" (6 caract\xE8res min.) :

\xC0 communiquer manuellement \xE0 la personne concern\xE9e.`);
    if (!newPassword)
      return;
    if (newPassword.length < 6) {
      this.actionErreur = "Le nouveau mot de passe doit contenir au moins 6 caract\xE8res.";
      return;
    }
    this.actionLoading = u.id;
    this.actionErreur = null;
    this.sa.resetUserPassword(u.id, newPassword).subscribe({
      next: () => {
        this.actionLoading = "";
        alert(`Mot de passe de "${nom}" r\xE9initialis\xE9 avec succ\xE8s.`);
      },
      error: (err) => {
        this.actionLoading = "";
        this.actionErreur = err?.error?.error ?? "Erreur lors de la r\xE9initialisation.";
      }
    });
  }
  delete(u) {
            ...
            <tr [class.suspended]="u.suspended">\r
              ...
              <td>\r
                <div class="sa-actions">\r
                  ...
                  <button class="sa-act-btn" (click)="resetPassword(u)" [disabled]="actionLoading === u.id" title="R\xE9initialiser le mot de passe">\r
...
function SaSettingsComponent_Conditional_12_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "td");
    \u0275\u0275conditionalCreate(7, SaSettingsComponent_Conditional_12_For_15_Conditional_7_Template, 1, 1, "input", 31)(8, SaSettingsComponent_Conditional_12_For_15_Conditional_8_Template, 2, 5, "span", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td")(10, "div", 33);
...
function SaSettingsComponent_Conditional_12_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "span", 16);
    \u0275\u0275text(2, "check_circle");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r2.pwDone, " ");
  }
}
function SaSettingsComponent_Conditional_12_Conditional_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "span", 16);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r2.pwErreur, " ");
  }
}
function SaSettingsComponent_Conditional_12_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 27);
  }
}
function SaSettingsComponent_Conditional_12_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 16);
    \u0275\u0275text(1, "check");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, " Mettre \xE0 jour ");
  }
}
function SaSettingsComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "div", 18)(45, "div", 19)(46, "span", 16);
    \u0275\u0275text(47, "lock");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "h3");
    \u0275\u0275text(49, "Mon mot de passe");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "span", 20);
    \u0275\u0275text(51, "Change ton propre mot de passe superadmin");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 21)(53, "input", 28);
    \u0275\u0275twoWayListener("ngModelChange", function SaSettingsComponent_Conditional_12_Template_input_ngModelChange_53_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.pwForm.ancien, $event) || (ctx_r2.pwForm.ancien = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "input", 29);
    \u0275\u0275twoWayListener("ngModelChange", function SaSettingsComponent_Conditional_12_Template_input_ngModelChange_54_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.pwForm.nouveau, $event) || (ctx_r2.pwForm.nouveau = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "input", 30);
    \u0275\u0275twoWayListener("ngModelChange", function SaSettingsComponent_Conditional_12_Template_input_ngModelChange_55_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(56, SaSettingsComponent_Conditional_12_Conditional_56_Template, 4, 1, "div", 24);
    \u0275\u0275conditionalCreate(57, SaSettingsComponent_Conditional_12_Conditional_57_Template, 4, 1, "div", 25);
    \u0275\u0275elementStart(58, "button", 26);
    \u0275\u0275listener("click", function SaSettingsComponent_Conditional_12_Template_button_click_58_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.changePassword());
    });
    \u0275\u0275conditionalCreate(59, SaSettingsComponent_Conditional_12_Conditional_59_Template, 1, 0, "span", 27)(60, SaSettingsComponent_Conditional_12_Conditional_60_Template, 3, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(11);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.pwForm.ancien);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.pwForm.nouveau);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.pwForm.confirm);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.pwDone ? 56 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.pwErreur ? 57 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r2.pwForm.ancien || !ctx_r2.pwForm.nouveau || ctx_r2.pwSaving);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.pwSaving ? 59 : 60);
  }
}
var SaSettingsComponent = class _SaSettingsComponent {
  ...
  sendBroadcast() {
    ...
    this.sa.broadcast(this.broadcastTitre, this.broadcastMsg).subscribe({
      next: (r) => {
        this.broadcastDone = `Envoy\xE9 \xE0 ${r.sent} membres (dont ${r.pushSent} notifications push)`;
        this.broadcastTitre = "";
        this.broadcastMsg = "";
  ...
  changePassword() {
    if (!this.pwForm.ancien || !this.pwForm.nouveau) {
      this.pwErreur = "Tous les champs sont requis.";
      return;
    }
    if (this.pwForm.nouveau !== this.pwForm.confirm) {
      this.pwErreur = "Les mots de passe ne correspondent pas.";
      return;
    }
    if (this.pwForm.nouveau.length < 8) {
      this.pwErreur = "Minimum 8 caract\xE8res.";
      return;
    }
    this.pwErreur = null;
    this.pwSaving = true;
    this.sa.changePassword(this.pwForm.ancien, this.pwForm.nouveau).subscribe({
      next: () => {
        this.pwSaving = false;
        this.pwDone = "Mot de passe mis \xE0 jour avec succ\xE8s.";
        this.pwForm = { ancien: "", nouveau: "", confirm: "" };
        setTimeout(() => this.pwDone = "", 5e3);
      },
      error: (err) => {
        this.pwSaving = false;
        this.pwErreur = err?.error?.error ?? "Erreur lors du changement.";
      }
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SaSettingsComponent, selectors: [["sa-settings"]], standalone: false, decls: 13, vars: 1, consts: [[1, "sa-page"], [1, "sa-page-header"], [1, "sa-defaults-bar"], [1, "sa-defaults-label"], [1, "sa-default-chip", 3, "disabled", "title"], [1, "sa-loading"], [1, "sa-default-chip", 3, "click", "disabled", "title"], [1, "error-state", 2, "margin-bottom", "16px"], [1, "sa-table-wrap"], [1, "sa-table"], [1, "sa-add-setting"], [1, "sa-add-row"], ["required", "", "placeholder", "cl\xE9 * (ex: max_upload_mb)", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], ["placeholder", "Label (optionnel)", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], ["required", "", "placeholder", "valeur *", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], [1, "sa-btn-add", 3, "click", "disabled"], [1, "material-icons-round"], [1, "error-state", 2, "margin-top", "10px"], [1, "sa-broadcast-card"], [1, "sa-broadcast-header"], [1, "sa-broadcast-warn"], [1, "sa-broadcast-fields"], ["placeholder", "Titre de la notification", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], ["placeholder", "Message...", "rows", "3", 1, "sa-textarea", 3, "ngModelChange", "ngModel"], [1, "sa-broadcast-success"], [1, "error-state", 2, "margin-bottom", "12px"], [1, "sa-btn-broadcast", 3, "click", "disabled"], [1, "sa-spinner-sm"], ["type", "password", "placeholder", "Ancien mot de passe", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], ["type", "password", "placeholder", "Nouveau mot de passe (8 caract\xE8res min.)", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], ["type", "password", "placeholder", "Confirmer le nouveau mot de passe", 1, "sa-add-input", 3, "ngModelChange", "ngModel"], [1, "sa-inline-input", 3, "ngModel"], [1, "sa-setting-val", 3, "bool-true", "bool-false"], [1, "sa-actions"], [1, "sa-inline-input", 3, "ngModelChange", "ngModel"], [1, "sa-setting-val"], [1, "sa-act-btn", "green", 3, "click", "disabled"], [1, "sa-act-btn", 3, "click"], ["title", "Modifier", 1, "sa-act-btn", 3, "click"], ["title", "Supprimer", 1, "sa-act-btn", "danger", 3, "click"]], template: function SaSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(11, SaSettingsComponent_Conditional_11_Template, 2, 0, "div", 5)(12, SaSettingsComponent_Conditional_12_Template, 61, 19);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(9);
...
\r
    ...
    <div class="sa-broadcast-card">\r
      <div class="sa-broadcast-header">\r
        <span class="material-icons-round">lock</span>\r
        <h3>Mon mot de passe</h3>\r
        <span class="sa-broadcast-warn">Change ton propre mot de passe superadmin</span>\r
      </div>\r
      <div class="sa-broadcast-fields">\r
        <input type="password" [(ngModel)]="pwForm.ancien" placeholder="Ancien mot de passe" class="sa-add-input"/>\r
        <input type="password" [(ngModel)]="pwForm.nouveau" placeholder="Nouveau mot de passe (8 caract\xE8res min.)" class="sa-add-input"/>\r
        <input type="password" [(ngModel)]="pwForm.confirm" placeholder="Confirmer le nouveau mot de passe" class="sa-add-input"/>\r
      </div>\r
      @if (pwDone) {\r
        <div class="sa-broadcast-success">\r
          <span class="material-icons-round">check_circle</span> {{ pwDone }}\r
        </div>\r
      }\r
      @if (pwErreur) {\r
        <div class="error-state" style="margin-bottom:12px">\r
          <span class="material-icons-round">error_outline</span>{{ pwErreur }}\r
        </div>\r
      }\r
      <button class="sa-btn-broadcast" (click)="changePassword()" [disabled]="!pwForm.ancien || !pwForm.nouveau || pwSaving">\r
        @if (pwSaving) { <span class="sa-spinner-sm"></span> } @else {\r
          <span class="material-icons-round">check</span> Mettre \xE0 jour\r
        }\r
      </button>\r
    </div>\r
  }\r
...
//# sourceMappingURL=chunk-QCFSAPMM.js.map
