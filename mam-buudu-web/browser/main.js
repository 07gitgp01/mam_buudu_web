...
function LandingComponent_div_23_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 156);
    \u0275\u0275listener("click", function LandingComponent_div_23_div_7_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function LandingComponent_div_23_div_8_button_1_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingComponent_div_23_div_8_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 159);
    \u0275\u0275listener("click", function LandingComponent_div_23_div_8_button_1_Template_button_click_0_listener() {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, LandingComponent_div_23_div_8_button_1_span_4_Template, 2, 0, "span", 161);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LandingComponent_div_23_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 157);
    \u0275\u0275template(1, LandingComponent_div_23_div_8_button_1_Template, 5, 7, "button", 158);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function LandingComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingComponent_div_23_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(7, LandingComponent_div_23_div_7_Template, 1, 0, "div", 154)(8, LandingComponent_div_23_div_8_Template, 2, 1, "div", 155);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function LandingComponent_ng_container_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 163)(2, "span", 19);
    \u0275\u0275text(3, "people");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " Espace Famille ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "a", 164)(6, "span", 19);
...
function LandingComponent_ng_container_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 165)(2, "span", 19);
    \u0275\u0275text(3, "dashboard");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " Mon espace ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 166);
    \u0275\u0275listener("click", function LandingComponent_ng_container_25_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function LandingComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 167);
    \u0275\u0275listener("click", function LandingComponent_div_29_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
function LandingComponent_div_66_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 172);
    \u0275\u0275listener("click", function LandingComponent_div_66_button_4_Template_button_click_0_listener() {
...
function LandingComponent_div_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 168)(1, "span", 169);
    \u0275\u0275text(2, "Th\xE8me");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 170);
    \u0275\u0275template(4, LandingComponent_div_66_button_4_Template, 1, 5, "button", 171);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function LandingComponent_ng_container_68_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 173);
    \u0275\u0275listener("click", function LandingComponent_ng_container_68_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.navOpen = false);
    });
    ...
    \u0275\u0275listener("click", function LandingComponent_ng_container_68_Template_a_click_5_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.navOpen = false);
    });
...
function LandingComponent_ng_container_69_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 175);
    \u0275\u0275listener("click", function LandingComponent_ng_container_69_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.navOpen = false);
    });
    ...
    \u0275\u0275listener("click", function LandingComponent_ng_container_69_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1.logout();
      return \u0275\u0275resetView(ctx_r1.navOpen = false);
...
function LandingComponent_ng_container_95_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 177)(2, "div", 178)(3, "span", 19);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "a", 181)(13, "div", 182)(14, "span", 19);
...
function LandingComponent_ng_container_96_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 183)(2, "div", 178)(3, "span", 19);
    \u0275\u0275text(4, "dashboard");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 179)(6, "strong");
    ...
    \u0275\u0275listener("click", function LandingComponent_ng_container_96_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.logout());
    });
    \u0275\u0275elementStart(13, "div", 182)(14, "span", 19);
    \u0275\u0275text(15, "logout");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 179)(17, "strong");
...
function LandingComponent_div_206_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 185)(1, "div", 186)(2, "span", 19);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "h4");
    \u0275\u0275text(5);
...
function LandingComponent_section_207_div_10_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingComponent_section_207_div_10_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingComponent_section_207_div_10_li_9_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingComponent_section_207_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 190);
    \u0275\u0275template(1, LandingComponent_section_207_div_10_span_1_Template, 2, 0, "span", 191);
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, LandingComponent_section_207_div_10_span_7_Template, 2, 0, "span", 195);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "ul", 196);
    \u0275\u0275template(9, LandingComponent_section_207_div_10_li_9_Template, 4, 1, "li", 197);
    \u0275\u0275elementEnd();
...
function LandingComponent_section_207_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 187)(1, "div", 89)(2, "div", 90)(3, "span", 91);
    \u0275\u0275text(4, "Tarifs");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "h2");
    ...
    \u0275\u0275template(10, LandingComponent_section_207_div_10_Template, 12, 10, "div", 189);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function LandingComponent_div_218_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 205)(8, "span", 19);
    \u0275\u0275text(9, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
...
function LandingComponent_div_228_button_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 220);
    \u0275\u0275listener("click", function LandingComponent_div_228_button_15_Template_button_click_0_listener() {
...
function LandingComponent_div_228_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, LandingComponent_div_228_button_15_Template, 1, 2, "button", 219);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function LandingComponent_div_280_div_8_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingComponent_div_280_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 221)(1, "button", 222);
    \u0275\u0275listener("click", function LandingComponent_div_280_Template_button_click_1_listener() {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(8, LandingComponent_div_280_div_8_Template, 3, 1, "div", 226);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var LandingComponent = class _LandingComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingComponent, selectors: [["app-landing"]], standalone: false, decls: 322, vars: 22, consts: [[1, "landing-nav"], ["routerLink", "/", 1, "nav-logo"], ["width", "26", "height", "26", "viewBox", "0 0 120 120", "fill", "none"], ["x", "50", "y", "60", "width", "20", "height", "40", "fill", "#8B4513", "rx", "2"], ["d", "M60 60 L40 40", "stroke", "#8B4513", "stroke-width", "6", "stroke-linecap", "round"], ["d", "M60 60 L80 40", "stroke", "#8B4513", "stroke-width", "6", "stroke-linecap", "round"], ["cx", "35", "cy", "35", "r", "10", "fill", "#2E7D32"], ["cx", "85", "cy", "35", "r", "10", "fill", "#2E7D32"], ["cx", "60", "cy", "25", "r", "10", "fill", "#81C784"], [1, "nav-links"], ["href", "#features", 1, "nav-link"], ["href", "#familles", 1, "nav-link"], ["href", "#tarifs", 1, "nav-link"], ["href", "#temoignages", 1, "nav-link"], ["href", "#faq", 1, "nav-link"], [1, "nav-actions"], ["class", "theme-switch", 4, "ngIf"], [4, "ngIf"], ["aria-label", "Menu", 1, "nav-hamburger", 3, "click"], [1, "material-icons-round"], ["class", "nav-mobile-overlay", 3, "click", 4, "ngIf"], [1, "nav-mobile-sheet"], [1, "nms-header"], [1, "nav-logo", "nms-logo"], ["width", "24", "height", "24", "viewBox", "0 0 120 120", "fill", "none"], [1, "nms-close", 3, "click"], [1, "nms-links"], ["href", "#features", 1, "nms-link", 3, "click"], ["href", "#familles", 1, "nms-link", 3, "click"], ["href", "#tarifs", 1, "nms-link", 3, "click"], ["href", "#temoignages", 1, "nms-link", 3, "click"], ["href", "#faq", 1, "nms-link", 3, "click"], ["class", "nms-theme-picker", 4, "ngIf"], [1, "nms-actions"], [1, "hero"], [1, "hero-sparks"], [1, "spark", 2, "left", "12%", "animation-delay", "0s"], [1, "spark", 2, "left", "24%", "animation-delay", "1.4s", "width", "4px", "height", "4px"], [1, "spark", 2, "left", "38%", "animation-delay", "2.6s"], [1, "spark", 2, "left", "55%", "animation-delay", "0.7s", "width", "4px", "height", "4px"], [1, "spark", 2, "left", "68%", "animation-delay", "3.4s"], [1, "spark", 2, "left", "81%", "animation-delay", "1.9s", "width", "4px", "height", "4px"], [1, "hero-inner"], [1, "hero-badge", "fade-up-1"], [1, "hero-title", "fade-up-2"], [1, "accent"], [1, "hero-sub", "fade-up-3"], [1, "hero-entries", "fade-up-4"], [1, "hero-tree-wrap"], ["width", "480", "height", "560", "viewBox", "0 0 480 560", "fill", "none"], ["d", "M240 520 C 220 500, 200 495, 175 505", "stroke", "#8B4513", "stroke-width", "3", "fill", "none", "opacity", "0.55", 1, "tree-line", "g-root"], ["d", "M240 520 C 260 500, 280 495, 305 505", "stroke", "#8B4513", "stroke-width", "3", "fill", "none", "opacity", "0.55", 1, "tree-line", "g-root"], ["d", "M240 520 L 240 545", "stroke", "#8B4513", "stroke-width", "4", "opacity", "0.55", 1, "tree-line", "g-root"], ["d", "M240 520 L 240 400", "stroke", "#8B4513", "stroke-width", "7", "stroke-linecap", "round", 1, "tree-line", "g-trunk"], ["d", "M240 400 C 210 380, 180 365, 150 340", "stroke", "#8B4513", "stroke-width", "5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-trunk"], ["d", "M240 400 C 270 380, 300 365, 330 340", "stroke", "#8B4513", "stroke-width", "5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-trunk"], ["d", "M240 400 L 240 330", "stroke", "#8B4513", "stroke-width", "5", "stroke-linecap", "round", 1, "tree-line", "g-trunk"], ["d", "M150 340 C 130 315, 115 300, 95 280", "stroke", "#8B4513", "stroke-width", "3.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-1"], ["d", "M150 340 C 155 310, 150 290, 140 265", "stroke", "#8B4513", "stroke-width", "3.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-1"], ["d", "M330 340 C 350 315, 365 300, 385 280", "stroke", "#8B4513", "stroke-width", "3.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-1"], ["d", "M330 340 C 325 310, 330 290, 340 265", "stroke", "#8B4513", "stroke-width", "3.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-1"], ["d", "M240 330 C 225 305, 225 290, 235 265", "stroke", "#8B4513", "stroke-width", "3.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-1"], ["d", "M240 330 C 255 305, 255 290, 245 265", "stroke", "#8B4513", "stroke-width", "3.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-1"], ["d", "M95 280 C 85 260, 82 245, 88 225", "stroke", "#8B4513", "stroke-width", "2.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-2"], ["d", "M140 265 C 135 245, 138 230, 148 210", "stroke", "#8B4513", "stroke-width", "2.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-2"], ["d", "M385 280 C 395 260, 398 245, 392 225", "stroke", "#8B4513", "stroke-width", "2.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-2"], ["d", "M340 265 C 345 245, 342 230, 332 210", "stroke", "#8B4513", "stroke-width", "2.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-2"], ["d", "M235 265 C 225 240, 228 222, 220 200", "stroke", "#8B4513", "stroke-width", "2.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-2"], ["d", "M245 265 C 255 240, 252 222, 260 200", "stroke", "#8B4513", "stroke-width", "2.5", "fill", "none", "stroke-linecap", "round", 1, "tree-line", "g-2"], ["cx", "88", "cy", "220", "r", "16", "fill", "#2E7D32", 1, "leaf", 2, "animation-delay", "1.4s, 1.9s"], ["cx", "148", "cy", "205", "r", "14", "fill", "#81C784", 1, "leaf", 2, "animation-delay", "1.5s, 2.1s"], ["cx", "220", "cy", "196", "r", "16", "fill", "#2E7D32", 1, "leaf", 2, "animation-delay", "1.6s, 1.7s"], ["cx", "260", "cy", "196", "r", "14", "fill", "#81C784", 1, "leaf", 2, "animation-delay", "1.65s, 2.4s"], ["cx", "332", "cy", "205", "r", "14", "fill", "#2E7D32", 1, "leaf", 2, "animation-delay", "1.55s, 2.0s"], ["cx", "392", "cy", "220", "r", "16", "fill", "#81C784", 1, "leaf", 2, "animation-delay", "1.45s, 1.85s"], ["cx", "95", "cy", "280", "r", "9", "fill", "#3B82F6", "opacity", "0.85", 1, "leaf", 2, "animation-delay", "1.0s, 2.6s"], ["cx", "140", "cy", "265", "r", "8", "fill", "#EC4899", "opacity", "0.85", 1, "leaf", 2, "animation-delay", "1.05s, 2.2s"], ["cx", "240", "cy", "330", "r", "9", "fill", "#F59E0B", "opacity", "0.85", 1, "leaf", 2, "animation-delay", "0.75s, 2.8s"], ["cx", "340", "cy", "265", "r", "8", "fill", "#EC4899", "opacity", "0.85", 1, "leaf", 2, "animation-delay", "1.05s, 2.35s"], ["cx", "385", "cy", "280", "r", "9", "fill", "#3B82F6", "opacity", "0.85", 1, "leaf", 2, "animation-delay", "1.0s, 1.95s"], ["cx", "150", "cy", "340", "r", "10", "fill", "#8B5CF6", "opacity", "0.9", 1, "leaf", 2, "animation-delay", "0.65s, 3.0s"], ["cx", "330", "cy", "340", "r", "10", "fill", "#8B5CF6", "opacity", "0.9", 1, "leaf", 2, "animation-delay", "0.65s, 2.5s"], [1, "stats-section"], [1, "container", "stats-grid"], [1, "stat-box"], [1, "stat-icon"], [1, "stat-number"], [1, "stat-label"], [1, "solution"], [1, "container"], [1, "sec-head"], [1, "sec-tag"], [1, "sol-grid"], [1, "sol-card"], [1, "sol-icon"], ["id", "features", 1, "features"], [1, "feat-layout"], [1, "feat-left"], [1, "feat-grid"], ["class", "feat-card", 4, "ngFor", "ngForOf"], ["class", "pricing", "id", "tarifs", 4, "ngIf"], ["id", "familles", 1, "familles"], [1, "fam-grid"], ["class", "fam-card", 4, "ngFor", "ngForOf"], ["id", "temoignages", 1, "testimonials"], [1, "sec-tag", "sec-tag-dark"], ["class", "testi-wrap", 4, "ngIf"], [1, "mobile-download"], [1, "container", "mobile-download-inner"], [1, "mdl-text"], [1, "mdl-badges"], [1, "store-badge", "store-badge-soon"], [1, "store-badge-text"], [1, "mdl-visual"], ["width", "220", "height", "300", "viewBox", "0 0 220 300", "fill", "none"], ["x", "10", "y", "10", "width", "200", "height", "280", "rx", "28", "fill", "#0F2A1E", "stroke", "#123B27", "stroke-width", "2"], ["x", "20", "y", "34", "width", "180", "height", "232", "rx", "10", "fill", "#F0FDF4"], ["cx", "110", "cy", "22", "r", "3", "fill", "#123B27"], ["cx", "60", "cy", "90", "r", "16", "fill", "#81C784"], ["cx", "110", "cy", "70", "r", "20", "fill", "#2E7D32"], ["cx", "160", "cy", "90", "r", "16", "fill", "#81C784"], ["d", "M60 106 L60 140 M110 90 L110 140 M160 106 L160 140", "stroke", "#8B4513", "stroke-width", "3"], ["d", "M60 140 L110 140 L160 140", "stroke", "#8B4513", "stroke-width", "3"], ["x", "40", "y", "150", "width", "140", "height", "10", "rx", "5", "fill", "#DCFCE7"], ["x", "40", "y", "170", "width", "100", "height", "10", "rx", "5", "fill", "#DCFCE7"], ["x", "40", "y", "190", "width", "120", "height", "10", "rx", "5", "fill", "#DCFCE7"], ["id", "faq", 1, "faq"], [1, "faq-head"], [1, "faq-toggle-all"], [1, "faq-toggle-btn", 3, "click"], [1, "faq-toggle-btn", 3, "click", "disabled"], [1, "faq-list"], ["class", "faq-item", 3, "open", 4, "ngFor", "ngForOf"], [1, "cta"], [1, "cta-box"], [1, "cta-actions"], ["routerLink", "/famille/login", 1, "cta-btn", "cta-btn-primary"], ["routerLink", "/auth/login", 1, "cta-btn", "cta-btn-ghost"], [1, "landing-footer"], [1, "container", "footer-inner"], [1, "footer-brand"], ["width", "18", "height", "18", "viewBox", "0 0 120 120", "fill", "none"], [1, "footer-sep"], [1, "footer-by"], [1, "footer-links"], ["routerLink", "/famille/login"], ["routerLink", "/auth/login"], ["routerLink", "/auth/register"], [1, "footer-copy"], [1, "theme-switch"], ["aria-haspopup", "listbox", 1, "theme-switch-btn", 3, "click"], [1, "theme-switch-dot"], [1, "theme-switch-name"], [1, "material-icons-round", "theme-switch-chevron"], ["class", "theme-switch-overlay", 3, "click", 4, "ngIf"], ["class", "theme-switch-menu", "role", "listbox", 4, "ngIf"], [1, "theme-switch-overlay", 3, "click"], ["role", "listbox", 1, "theme-switch-menu"], ["class", "theme-switch-option", "role", "option", 3, "active", "click", 4, "ngFor", "ngForOf"], ["role", "option", 1, "theme-switch-option", 3, "click"], [1, "theme-switch-label"], ["class", "material-icons-round theme-switch-check", 4, "ngIf"], [1, "material-icons-round", "theme-switch-check"], ["routerLink", "/famille/login", 1, "btn-nav-famille"], ["routerLink", "/auth/login", 1, "btn-nav-admin"], [1, "btn-nav-famille", 3, "routerLink"], [1, "btn-nav-logout", 3, "click"], [1, "nav-mobile-overlay", 3, "click"], [1, "nms-theme-picker"], [1, "nms-theme-label"], [1, "nms-theme-dots"], ["class", "nms-theme-dot", 3, "background", "active", "title", "click", 4, "ngFor", "ngForOf"], [1, "nms-theme-dot", 3, "click", "title"], ["routerLink", "/famille/login", 1, "nms-btn", "nms-btn-famille", 3, "click"], ["routerLink", "/auth/login", 1, "nms-btn", "nms-btn-admin", 3, "click"], [1, "nms-btn", "nms-btn-famille", 3, "click", "routerLink"], [1, "nms-btn", "nms-btn-logout", 3, "click"], ["routerLink", "/famille/login", 1, "entry-card"], [1, "entry-icon", "famille"], [1, "entry-info"], [1, "material-icons-round", "arrow"], ["routerLink", "/auth/login", 1, "entry-card"], [1, "entry-icon", "admin"], [1, "entry-card", 3, "routerLink"], [1, "entry-card", 3, "click"], [1, "feat-card"], [1, "feat-icon"], ["id", "tarifs", 1, "pricing"], [1, "pricing-grid"], ["class", "price-card", 3, "price-card-highlight", 4, "ngFor", "ngForOf"], [1, "price-card"], ["class", "price-badge", 4, "ngIf"], [1, "price-label"], [1, "price-value"], [1, "price-amount"], ["class", "price-period", 4, "ngIf"], [1, "price-features"], [4, "ngFor", "ngForOf"], ["routerLink", "/auth/register", 1, "price-cta"], [1, "price-badge"], [1, "price-period"], [1, "fam-card"], [1, "fam-head"], [1, "fam-avatar"], [1, "fam-name"], [1, "fam-origin"], [1, "fam-stats"], [1, "fam-stat"], [1, "fam-stat-val"], [1, "fam-stat-label"], [1, "testi-wrap"], [1, "testi-card"], [1, "material-icons-round", "testi-quote-icon"], [1, "testi-text"], [1, "testi-author"], [1, "testi-avatar"], [1, "testi-name"], [1, "testi-role"], [1, "testi-dots"], ["class", "testi-dot", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "testi-dot", 3, "click"], [1, "faq-item"], [1, "faq-question", 3, "click"], [1, "faq-num"], [1, "faq-question-text"], [1, "material-icons-round", "faq-icon"], ["class", "faq-answer", 4, "ngIf"], [1, "faq-answer"]], template: function LandingComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(19, "T\xE9moignages");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "a", 14);
      \u0275\u0275text(21, "FAQ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "div", 15);
      \u0275\u0275template(23, LandingComponent_div_23_Template, 9, 8, "div", 16)(24, LandingComponent_ng_container_24_Template, 9, 0, "ng-container", 17)(25, LandingComponent_ng_container_25_Template, 9, 1, "ng-container", 17);
      \u0275\u0275elementStart(26, "button", 18);
      \u0275\u0275listener("click", function LandingComponent_Template_button_click_26_listener() {
        return ctx.navOpen = !ctx.navOpen;
      });
      \u0275\u0275elementStart(27, "span", 19);
      \u0275\u0275text(28);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(29, LandingComponent_div_29_Template, 1, 0, "div", 20);
      \u0275\u0275elementStart(30, "div", 21)(31, "div", 22)(32, "div", 23);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(33, "svg", 24);
      \u0275\u0275element(34, "rect", 3)(35, "path", 4)(36, "path", 5)(37, "circle", 6)(38, "circle", 7)(39, "circle", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      ...
      \u0275\u0275listener("click", function LandingComponent_Template_button_click_42_listener() {
      ...
      \u0275\u0275listener("click", function LandingComponent_Template_a_click_46_listener() {
        return ctx.navOpen = false;
      });
      \u0275\u0275elementStart(47, "span", 19);
      \u0275\u0275text(48, "star");
      \u0275\u0275elementEnd();
      \u0275\u0275text(49, "Fonctionnalit\xE9s ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(50, "a", 28);
      \u0275\u0275listener("click", function LandingComponent_Template_a_click_50_listener() {
        return ctx.navOpen = false;
      });
      ...
      \u0275\u0275listener("click", function LandingComponent_Template_a_click_54_listener() {
        return ctx.navOpen = false;
      });
      ...
      \u0275\u0275text(57, "Tarifs ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "a", 30);
      \u0275\u0275listener("click", function LandingComponent_Template_a_click_58_listener() {
        return ctx.navOpen = false;
      });
      \u0275\u0275elementStart(59, "span", 19);
      \u0275\u0275text(60, "format_quote");
      \u0275\u0275elementEnd();
      \u0275\u0275text(61, "T\xE9moignages ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(62, "a", 31);
      \u0275\u0275listener("click", function LandingComponent_Template_a_click_62_listener() {
        return ctx.navOpen = false;
      });
      \u0275\u0275elementStart(63, "span", 19);
      \u0275\u0275text(64, "help_outline");
      \u0275\u0275elementEnd();
      \u0275\u0275text(65, "FAQ ");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(66, LandingComponent_div_66_Template, 5, 1, "div", 32);
      \u0275\u0275elementStart(67, "div", 33);
      \u0275\u0275template(68, LandingComponent_ng_container_68_Template, 9, 0, "ng-container", 17)(69, LandingComponent_ng_container_69_Template, 9, 1, "ng-container", 17);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(70, "section", 34)(71, "div", 35);
      \u0275\u0275element(72, "div", 36)(73, "div", 37)(74, "div", 38)(75, "div", 39)(76, "div", 40)(77, "div", 41);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(78, "div", 42)(79, "div")(80, "span", 43)(81, "span", 19);
      \u0275\u0275text(82, "auto_awesome");
      \u0275\u0275elementEnd();
      \u0275\u0275text(83, " Application g\xE9n\xE9alogique africaine ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(84, "h1", 44);
      \u0275\u0275text(85, " L'histoire de votre");
      \u0275\u0275element(86, "br");
      \u0275\u0275elementStart(87, "span", 45);
      \u0275\u0275text(88, "famille");
      \u0275\u0275elementEnd();
      \u0275\u0275text(89, ",");
      \u0275\u0275element(90, "br");
      \u0275\u0275text(91, " pr\xE9serv\xE9e pour toujours ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(92, "p", 46);
      \u0275\u0275text(93, " Construisez l'arbre g\xE9n\xE9alogique de votre famille, partagez vos stories et connectez les g\xE9n\xE9rations \xE0 travers le temps. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(94, "div", 47);
      \u0275\u0275template(95, LandingComponent_ng_container_95_Template, 23, 0, "ng-container", 17)(96, LandingComponent_ng_container_96_Template, 23, 2, "ng-container", 17);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(97, "div", 48);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(98, "svg", 49);
      \u0275\u0275element(99, "path", 50)(100, "path", 51)(101, "path", 52)(102, "path", 53)(103, "path", 54)(104, "path", 55)(105, "path", 56)(106, "path", 57)(107, "path", 58)(108, "path", 59)(109, "path", 60)(110, "path", 61)(111, "path", 62)(112, "path", 63)(113, "path", 64)(114, "path", 65)(115, "path", 66)(116, "path", 67)(117, "path", 68)(118, "circle", 69)(119, "circle", 70)(120, "circle", 71)(121, "circle", 72)(122, "circle", 73)(123, "circle", 74)(124, "circle", 75)(125, "circle", 76)(126, "circle", 77)(127, "circle", 78)(128, "circle", 79)(129, "circle", 80)(130, "circle", 81);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(131, "section", 82)(132, "div", 83)(133, "div", 84)(134, "div", 85)(135, "span", 19);
      \u0275\u0275text(136, "family_restroom");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(137, "div")(138, "div", 86);
      \u0275\u0275text(139);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(140, "div", 87);
      \u0275\u0275text(141, "Familles");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(142, "div", 84)(143, "div", 85)(144, "span", 19);
      \u0275\u0275text(145, "people");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(146, "div")(147, "div", 86);
      \u0275\u0275text(148);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(149, "div", 87);
      \u0275\u0275text(150, "Membres");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(151, "div", 84)(152, "div", 85)(153, "span", 19);
      \u0275\u0275text(154, "favorite");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(155, "div")(156, "div", 86);
      \u0275\u0275text(157);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(158, "div", 87);
      \u0275\u0275text(159, "Unions");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(160, "div", 84)(161, "div", 85)(162, "span", 19);
      \u0275\u0275text(163, "auto_stories");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(164, "div")(165, "div", 86);
      \u0275\u0275text(166);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(167, "div", 87);
      \u0275\u0275text(168, "Stories");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(169, "section", 88)(170, "div", 89)(171, "div", 90)(172, "span", 91);
      \u0275\u0275text(173, "Notre solution");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(174, "h2");
      \u0275\u0275text(175, "Mam Buudu simplifie la g\xE9n\xE9alogie, pour toutes les familles.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(176, "p");
      \u0275\u0275text(177, "De la cr\xE9ation de l'arbre au partage des stories \u2014 une solution compl\xE8te, accessible en ligne ou hors ligne.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(178, "div", 92)(179, "div", 93)(180, "div", 94)(181, "span", 19);
      \u0275\u0275text(182, "account_tree");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(183, "h3");
      \u0275\u0275text(184, "Sans code, sans effort");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(185, "p");
      \u0275\u0275text(186, "Construisez votre arbre g\xE9n\xE9alogique facilement, sans aucune comp\xE9tence technique. En ligne ou hors ligne.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(187, "div", 93)(188, "div", 94)(189, "span", 19);
      \u0275\u0275text(190, "share");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(191, "h3");
      \u0275\u0275text(192, "Partage en famille");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(193, "p");
      \u0275\u0275text(194, "Invitez les membres, partagez les stories et connectez les g\xE9n\xE9rations en temps r\xE9el, depuis n'importe o\xF9.");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(195, "section", 95)(196, "div", 89)(197, "div", 96)(198, "div", 97)(199, "span", 91);
      \u0275\u0275text(200, "Bienvenue sur Mam Buudu");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(201, "h2");
      \u0275\u0275text(202, "G\xE9n\xE9alogie nouvelle g\xE9n\xE9ration");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(203, "p");
      \u0275\u0275text(204, "Construite pour \xE9quiper chaque famille d'outils modernes pour pr\xE9server et partager leur histoire. Nous rempla\xE7ons les albums \xE9parpill\xE9s et la m\xE9moire orale par une plateforme num\xE9rique s\xE9curis\xE9e, accessible \xE0 toute la famille.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(205, "div", 98);
      \u0275\u0275template(206, LandingComponent_div_206_Template, 8, 7, "div", 99);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(207, LandingComponent_section_207_Template, 11, 1, "section", 100);
      \u0275\u0275elementStart(208, "section", 101)(209, "div", 89)(210, "div", 90)(211, "span", 91);
      \u0275\u0275text(212, "Familles");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(213, "h2");
      \u0275\u0275text(214, "Des familles qui nous font confiance");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(215, "p");
      \u0275\u0275text(216, "Rejoignez des centaines de familles qui ont choisi Mam Buudu pour pr\xE9server leur patrimoine.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(217, "div", 102);
      \u0275\u0275template(218, LandingComponent_div_218_Template, 27, 16, "div", 103);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(219, "section", 104)(220, "div", 89)(221, "div", 90)(222, "span", 105);
      \u0275\u0275text(223, "T\xE9moignages");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(224, "h2");
      \u0275\u0275text(225, "Ce que disent nos utilisateurs");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(226, "p");
      \u0275\u0275text(227, "Ils ont choisi Mam Buudu pour connecter leur famille \xE0 travers les g\xE9n\xE9rations.");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(228, LandingComponent_div_228_Template, 16, 9, "div", 106);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(229, "section", 107)(230, "div", 108)(231, "div", 109)(232, "span", 91);
      \u0275\u0275text(233, "Application mobile");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(234, "h2");
      \u0275\u0275text(235, "Emportez l'arbre de votre famille partout");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(236, "p");
      \u0275\u0275text(237, "L'application mobile Mam Buudu est en cours de finalisation pour Android et iOS \u2014 retrouvez votre arbre, vos stories et vos proches, m\xEAme hors connexion.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(238, "div", 110)(239, "span", 111)(240, "span", 19);
      \u0275\u0275text(241, "apple");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(242, "span", 112)(243, "small");
      \u0275\u0275text(244, "Bient\xF4t sur");
      \u0275\u0275elementEnd();
      \u0275\u0275text(245, "App Store");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(246, "span", 111)(247, "span", 19);
      \u0275\u0275text(248, "shop");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(249, "span", 112)(250, "small");
      \u0275\u0275text(251, "Bient\xF4t sur");
      \u0275\u0275elementEnd();
      \u0275\u0275text(252, "Google Play");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(253, "div", 113);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(254, "svg", 114);
      \u0275\u0275element(255, "rect", 115)(256, "rect", 116)(257, "circle", 117)(258, "circle", 118)(259, "circle", 119)(260, "circle", 120)(261, "path", 121)(262, "path", 122)(263, "rect", 123)(264, "rect", 124)(265, "rect", 125);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(266, "section", 126)(267, "div", 89)(268, "div", 127)(269, "div")(270, "span", 91);
      \u0275\u0275text(271, "FAQ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(272, "h2");
      \u0275\u0275text(273, "Foire aux questions");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(274, "div", 128)(275, "button", 129);
      \u0275\u0275listener("click", function LandingComponent_Template_button_click_275_listener() {
        return ctx.setAllFaq(true);
      });
      \u0275\u0275text(276, "D\xE9velopper tout");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(277, "button", 130);
      \u0275\u0275listener("click", function LandingComponent_Template_button_click_277_listener() {
        return ctx.setAllFaq(false);
      });
      \u0275\u0275text(278, "R\xE9duire tout");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(279, "div", 131);
      \u0275\u0275template(280, LandingComponent_div_280_Template, 9, 6, "div", 132);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(281, "section", 133)(282, "div", 89)(283, "div", 134)(284, "h2");
      \u0275\u0275text(285, "Pr\xEAt \xE0 connecter votre famille ?");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(286, "p");
      \u0275\u0275text(287, "Rejoignez des milliers de familles qui pr\xE9servent leur histoire avec Mam Buudu.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(288, "div", 135)(289, "a", 136)(290, "span", 19);
      \u0275\u0275text(291, "family_restroom");
      \u0275\u0275elementEnd();
      \u0275\u0275text(292, " Acc\xE9der \xE0 mon espace famille ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(293, "a", 137)(294, "span", 19);
      \u0275\u0275text(295, "admin_panel_settings");
      \u0275\u0275elementEnd();
      \u0275\u0275text(296, " Espace administrateur ");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(297, "footer", 138)(298, "div", 139)(299, "div", 140);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(300, "svg", 141);
      \u0275\u0275element(301, "rect", 3)(302, "path", 4)(303, "path", 5)(304, "circle", 6)(305, "circle", 7)(306, "circle", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(307, "span");
      \u0275\u0275text(308, "Mam Buudu");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(309, "span", 142);
      \u0275\u0275text(310, "\xB7");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(311, "span", 143);
      \u0275\u0275text(312, "par Pbs");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(313, "div", 144)(314, "a", 145);
      \u0275\u0275text(315, "Espace Famille");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(316, "a", 146);
      \u0275\u0275text(317, "Administration");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(318, "a", 147);
      \u0275\u0275text(319, "Cr\xE9er un espace");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(320, "div", 148);
      \u0275\u0275text(321, "\xA9 2026 Pbs. Tous droits r\xE9serv\xE9s.");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(23);
