...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-SI3M7G33.js").then((m) => m.AuthModule)
  },
  {
    path: "app",
    canActivate: [authGuard, roleGuard(["admin", "gestionnaire"])],
    loadChildren: () => import("./chunk-FHVJZIR4.js").then((m) => m.ShellModule)
  },
  {
    path: "famille",
    loadChildren: () => import("./chunk-UUGDLBUJ.js").then((m) => m.FamilleModule)
  },
  {
    path: "superadmin",
    loadChildren: () => import("./chunk-QCFSAPMM.js").then((m) => m.SuperAdminModule)
  },
  { path: "**", redirectTo: "" }
];
