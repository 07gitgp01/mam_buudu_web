...
var ApiService = class _ApiService {
  ...
  importGedcom(file) {
    ...
    return this.http.post(`${this.base}/api/import/gedcom`, fd);
  }
  /* === Famille === */
  getCurrentFamille() {
  ...
  regenerateViewonlyPassword() {
    return this.http.post(`${this.base}/api/auth/viewonly-credentials/regenerate`, {});
  }
  updateProfile(data) {
    return this.http.patch(`${this.base}/api/auth/me`, data);
  }
  changePassword(data) {
    return this.http.post(`${this.base}/api/auth/change-password`, data);
  }
  /* === Historique / activité === */
  getActivity(page = 1, limit = 30) {
    return this.http.get(`${this.base}/api/activity`, { params: { page, limit } });
  }
  /* === Stories === */
  getStories(page = 1, limit = 20) {
    return this.http.get(`${this.base}/api/stories`, { params: { page, limit } });
  }
  createStory(data) {
  ...
  /* === Galerie familiale === */
  getGalerie(page = 1, limit = 24) {
    return this.http.get(`${this.base}/api/photos`, { params: { page, limit } });
  }
  /* === Albums photos === */
...
var ThemeService = class _ThemeService {
  renderer;
  themes = [
    { name: "foret", label: "For\xEAt", color: "#15803D" },
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-MAP5PQOL.js.map
