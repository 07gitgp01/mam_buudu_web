...
@Component({
  selector: 'app-famille-galerie',
  templateUrl: './famille-galerie.component.html',
  styleUrl: './famille-galerie.component.scss',
  standalone: false,
})
export class FamilleGalerieComponent implements OnInit {
  loading = true;
  loadingMore = false;
  erreur = '';
  photos: GaleriePhoto[] = [];
